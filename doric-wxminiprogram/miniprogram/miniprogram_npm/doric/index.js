  ...
  class Context {
    ...
    hookBeforeNativeCall() {
      if (this.entity && Reflect.has(this.entity, "hookBeforeNativeCall")) {
        Reflect.apply(
          Reflect.get(this.entity, "hookBeforeNativeCall"),
          this.entity,
          []
        );
      }
    ...
    hookAfterNativeCall() {
      if (this.entity && Reflect.has(this.entity, "hookAfterNativeCall")) {
        Reflect.apply(
          Reflect.get(this.entity, "hookAfterNativeCall"),
          this.entity,
          []
        );
      }
      ...
      if (arguments.length === 1) {
        ...
        if (srcContext) {
          ...
          if (clz) {
            ...
            throw new Error(
              `Cannot find class:${className} in context:${srcContextId}`
            );
          }
        } else {
...
function ViewComponent(constructor) {
  const name =
    Reflect.getMetadata(PROP_KEY_VIEW_TYPE, constructor) ||
...
class View {
  ...
  onPropertyChanged(propKey, oldV, newV) {
    ...
    viewTreeObserver === null || viewTreeObserver === void 0
      ? void 0
      : viewTreeObserver();
  }
  clean() {
...
__decorate$e(
  [Property, __metadata$e("design:type", Number)],
  View.prototype,
  "width",
  void 0
);
...
__decorate$e(
  [Property, __metadata$e("design:type", Object)],
  View.prototype,
  "backgroundColor",
  void 0
);
...
__decorate$e(
  [Property, __metadata$e("design:type", Boolean)],
  View.prototype,
  "hidden",
  void 0
);
...
__decorate$e(
  [Property, __metadata$e("design:type", Function)],
  View.prototype,
  "onClick",
  void 0
);
    ...
    for (let v of this.allSubviews()) {
      if (v != undefined) {
        if (v.superview && v.superview !== this) {
          ...
          for (let key in v) {
            if (
              Reflect.getMetadata(key, v) === PROP_CONSIST ||
              Reflect.getMetadata(key, v) === PROP_INCONSIST
            ) {
...
__decorate$d(
  [Property, __metadata$d("design:type", Number)],
  LinearLayout.prototype,
  "space",
  void 0
);
__decorate$d(
  [Property, __metadata$d("design:type", Gravity)],
  LinearLayout.prototype,
  "gravity",
  void 0
);
...
class BackgroundColorAnimation extends Animation {
  ...
  set keyFrames(keyFrames) {
    this.backgroundColorChangeable.keyFrames = keyFrames.map((e) => {
      return { percent: e.percent, value: e.value.toModel() };
    });
  }
}
/**
...
__decorate$b(
  [Property, __metadata$b("design:type", String)],
  Text.prototype,
  "text",
  void 0
);
__decorate$b(
  [Property, __metadata$b("design:type", Object)],
  Text.prototype,
  "textColor",
  void 0
);
__decorate$b(
  [Property, __metadata$b("design:type", Number)],
  Text.prototype,
  "textSize",
  void 0
);
...
__decorate$b(
  [Property, __metadata$b("design:type", Gravity)],
  Text.prototype,
  "textAlignment",
  void 0
);
...
__decorate$b(
  [Property, __metadata$b("design:type", Boolean)],
  Text.prototype,
  "strikethrough",
  void 0
);
...
__decorate$a(
  [Property, __metadata$a("design:type", Resource)],
  Image.prototype,
  "image",
  void 0
);
__decorate$a(
  [Property, __metadata$a("design:type", String)],
  Image.prototype,
  "imageUrl",
  void 0
);
...
__decorate$a(
  [Property, __metadata$a("design:type", Number)],
  Image.prototype,
  "scaleType",
  void 0
);
__decorate$a(
  [Property, __metadata$a("design:type", Boolean)],
  Image.prototype,
  "isBlur",
  void 0
);
...
__decorate$a(
  [Property, __metadata$a("design:type", Color)],
  Image.prototype,
  "errorColor",
  void 0
);
__decorate$a(
  [Property, __metadata$a("design:type", Function)],
  Image.prototype,
  "loadCallback",
  void 0
);
...
__decorate$a(
  [Property, __metadata$a("design:type", Object)],
  Image.prototype,
  "stretchInset",
  void 0
);
...
__decorate$9(
  [Property, __metadata$9("design:type", String)],
  ListItem.prototype,
  "identifier",
  void 0
);
__decorate$9(
  [Property, __metadata$9("design:type", Array)],
  ListItem.prototype,
  "actions",
  void 0
);
class List extends Superview {
  ...
  scrollToItem(context, index, config) {
    const animated =
      config === null || config === void 0 ? void 0 : config.animated;
  ...
  renderBunchedItems(start, length) {
    return new Array(Math.max(0, Math.min(length, this.itemCount - start)))
      .fill(0)
      .map((_, idx) => {
...
__decorate$9(
  [Property, __metadata$9("design:type", Object)],
  List.prototype,
  "itemCount",
  void 0
);
__decorate$9(
  [Property, __metadata$9("design:type", Function)],
  List.prototype,
  "renderItem",
  void 0
);
...
__decorate$9(
  [Property, __metadata$9("design:type", Boolean)],
  List.prototype,
  "loadMore",
  void 0
);
__decorate$9(
  [Property, __metadata$9("design:type", ListItem)],
  List.prototype,
  "loadMoreView",
  void 0
);
...
__decorate$9(
  [Property, __metadata$9("design:type", Number)],
  List.prototype,
  "scrolledPosition",
  void 0
);
...
__decorate$8(
  [Property, __metadata$8("design:type", String)],
  SlideItem.prototype,
  "identifier",
  void 0
);
class Slider extends Superview {
  ...
  renderBunchedItems(start, length) {
    return new Array(Math.min(length, this.itemCount - start))
      .fill(0)
      .map((_, idx) => {
...
__decorate$8(
  [Property, __metadata$8("design:type", Object)],
  Slider.prototype,
  "itemCount",
  void 0
);
__decorate$8(
  [Property, __metadata$8("design:type", Function)],
  Slider.prototype,
  "renderPage",
  void 0
);
...
__decorate$8(
  [Property, __metadata$8("design:type", Boolean)],
  Slider.prototype,
  "loop",
  void 0
);
...
__decorate$7(
  [Property, __metadata$7("design:type", Object)],
  Scroller.prototype,
  "contentOffset",
  void 0
);
__decorate$7(
  [Property, __metadata$7("design:type", Function)],
  Scroller.prototype,
  "onScroll",
  void 0
);
...
__decorate$7(
  [Property, __metadata$7("design:type", Boolean)],
  Scroller.prototype,
  "scrollable",
  void 0
);
...
__decorate$6(
  [Property, __metadata$6("design:type", Function)],
  Refreshable.prototype,
  "onRefresh",
  void 0
);
...
__decorate$5(
  [Property, __metadata$5("design:type", String)],
  FlowLayoutItem.prototype,
  "identifier",
  void 0
);
__decorate$5(
  [Property, __metadata$5("design:type", Boolean)],
  FlowLayoutItem.prototype,
  "fullSpan",
  void 0
);
...
__decorate$5(
  [Property, __metadata$5("design:type", Object)],
  FlowLayout.prototype,
  "columnCount",
  void 0
);
__decorate$5(
  [Property, __metadata$5("design:type", Number)],
  FlowLayout.prototype,
  "columnSpace",
  void 0
);
...
__decorate$5(
  [Property, __metadata$5("design:type", Function)],
  FlowLayout.prototype,
  "renderItem",
  void 0
);
...
__decorate$5(
  [Property, __metadata$5("design:type", FlowLayoutItem)],
  FlowLayout.prototype,
  "loadMoreView",
  void 0
);
...
__decorate$4(
  [InconsistProperty, __metadata$4("design:type", String)],
  Input.prototype,
  "text",
  void 0
);
__decorate$4(
  [Property, __metadata$4("design:type", Color)],
  Input.prototype,
  "textColor",
  void 0
);
__decorate$4(
  [Property, __metadata$4("design:type", Number)],
  Input.prototype,
  "textSize",
  void 0
);
__decorate$4(
  [Property, __metadata$4("design:type", String)],
  Input.prototype,
  "font",
  void 0
);
...
__decorate$4(
  [Property, __metadata$4("design:type", Boolean)],
  Input.prototype,
  "multiline",
  void 0
);
__decorate$4(
  [Property, __metadata$4("design:type", Gravity)],
  Input.prototype,
  "textAlignment",
  void 0
);
__decorate$4(
  [Property, __metadata$4("design:type", Function)],
  Input.prototype,
  "onTextChange",
  void 0
);
...
__decorate$3(
  [Property, __metadata$3("design:type", Function)],
  NestedSlider.prototype,
  "onPageSlided",
  void 0
);
__decorate$3(
  [Property, __metadata$3("design:type", Boolean)],
  NestedSlider.prototype,
  "scrollable",
  void 0
);
...
__decorate$2(
  [Property, __metadata$2("design:type", Function)],
  Draggable.prototype,
  "onDrag",
  void 0
);
...
__decorate$1(
  [InconsistProperty, __metadata$1("design:type", Boolean)],
  Switch.prototype,
  "state",
  void 0
);
__decorate$1(
  [Property, __metadata$1("design:type", Function)],
  Switch.prototype,
  "onSwitch",
  void 0
);
__decorate$1(
  [Property, __metadata$1("design:type", Color)],
  Switch.prototype,
  "offTintColor",
  void 0
);
...
function navbar(context) {
  ...
  return {
    ...
    setBgColor: (color) => {
      return context.callNative("navbar", "setBgColor", {
        color: color.toModel(),
      });
    },
    setLeft: (view) => {
...
function internalScheme(context, panelClass) {
  return `_internal_://export?class=${encodeURIComponent(
    panelClass.name
  )}&context=${context.id}`;
}
          ...
          for (let map of panel.allHeadViews()) {
            for (let v of map.values()) {
              if (v.isDirty()) {
                ...
                const ret_1 = context.callNative(
                  "animate",
                  "animateRender",
                  model_1
                );
...
function statusbar(context) {
  return {
    ...
    setColor: (color) => {
      return context.callNative("statusbar", "setColor", {
        color: color.toModel(),
      });
    },
  };
...
class Module extends Panel {
  ...
  get provider() {
    ...
    return (
      this.__provider ||
      ((_a = this.superPanel) === null || _a === void 0 ? void 0 : _a.provider)
    );
  }
  ...
  mount() {
    ...
    if (this.unmounted) {
      this.unmounted = false;
      (_a = this.superPanel) === null || _a === void 0
        ? void 0
        : _a.onStructureChanged(this, true);
      this.onMounted();
    }
  }
  unmount() {
    ...
    if (!this.unmounted) {
      ...
      (_a = this.superPanel) === null || _a === void 0
        ? void 0
        : _a.onStructureChanged(this, false);
      this.onUnmounted();
    }
  }
  get mounted() {
